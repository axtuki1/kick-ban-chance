...
export class CloudflareUtils {
    public static async InsertTargetPlayer(playerId, playerName, joinDate, joinDuration, action, startCount, targetPlayerCount) {
        ...
        try {
            ...
            await client.d1.database.query(
                process.env.CLOUDFLARE_DATABASE_ID,
                {
                    ...
                    sql: `INSERT INTO history (uuid, date, playerId, displayName, joinDate, joinDuration, action, startCount, targetPlayerCount) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`,
                    params: [
                        uuid(),
